...
test('bundled stdio server initializes and lists the unified tool surface', async () => {
  ...
  try {
    ...
    assert.deepEqual(listed.result.tools.map(tool => tool.name).sort(), [
      'uagents_cancel', 'uagents_council_diff', 'uagents_council_result', 'uagents_council_status', 'uagents_council_submit', 'uagents_ensure', 'uagents_get_capabilities', 'uagents_list_models', 'uagents_list_targets', 'uagents_list_tasks',
