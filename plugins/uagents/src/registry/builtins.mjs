...
export const BUILTIN_REGISTRY = Object.freeze({
  ...
  models: Object.freeze({
    ...
    'claude-sonnet-4-6': Object.freeze({ target: 'claudeCode', model: 'claude-sonnet-4-6', provider: 'claudeCode', route_id: 'claudeCode/claude-sonnet-4-6', kind: 'exact', enabled: true, opt_in: false }),
    'claudeCode/deepseek-v4-pro[1m]': Object.freeze({ target: 'claudeCode', model: 'deepseek-v4-pro[1m]', provider: 'deepseek', route_id: 'claudeCode/deepseek-v4-pro[1m]', kind: 'exact', enabled: true, opt_in: false }),
    'claudeCode/deepseek-v4-pro': Object.freeze({ target: 'claudeCode', model: 'deepseek-v4-pro', provider: 'deepseek', route_id: 'claudeCode/deepseek-v4-pro', kind: 'exact', enabled: true, opt_in: false }),
    'claudeCode/deepseek-v4-flash': Object.freeze({ target: 'claudeCode', model: 'deepseek-v4-flash', provider: 'deepseek', route_id: 'claudeCode/deepseek-v4-flash', kind: 'exact', enabled: true, opt_in: false }),
