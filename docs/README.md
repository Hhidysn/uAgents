...
- [Explicit Candidate Adopt 当前状态](status/2026-09-11-explicit-candidate-adopt-current.md)：显式选定 member 后，把候选 tracked/untracked 改动应用到指定 base workspace，不自动 commit/merge。
